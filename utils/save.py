...
def save_training_meta(args):
    ...
    # TODO: save according to the new one
    # new_model_config = {}
    # for encoder, config in model_config.items():
    #     new_model_config[encoder] = {}
    #     for key, value in config.items():
    #         new_model_config[encoder][key] = model.encoder.key
    # save_json(new_model_config, save_model_config_path, save_pretty=True)
    # print(model.v_encoder.f_encoder.embeddings.word_embeddings.weight.size())
    # print(model.v_encoder.f_encoder.embeddings.token_type_embeddings)
    # git info
    try:
